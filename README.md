...
![لقطة للشاشة الرئيسية للأداة](ضع-رابط-صورة-الواجهة-الرئيسية-هنا)
...
`![صورة تظهر القالب الافتراضي التعليمي لأول مرة](ضع-رابط-صورة-القالب-الافتراضي-هنا)`
...
- **أقسام وهيكل المستند**
  ...
  **مكان مقترح لصورة توضح الفهرس الجانبي وعناوين الأقسام:**  
  `![صورة للفهرس الجانبي (Sidebar) مع أقسام رئيسية وفرعية](ضع-رابط-صورة-الفهرس-الجانبي-هنا)`
...
- **تنبيهات وسلامة**
  ...
  **مكان مقترح لصورة توضح تنبيهات الأمان بألوانها:**  
  `![صورة تعرض أمثلة للتنبيهات الأربعة (info/success/warning/danger)](ضع-رابط-صورة-التنبيهات-هنا)`
...
`![صورة متحركة GIF أو ثابتة توضح سحب كتلة من مكان لآخر](ضع-رابط-صورة-السحب-والافلات-هنا)`
...
`![صورة لشريط التنسيق العائم فوق نص محدد يوضح خيارات Bold/Tags/Emoji](ضع-رابط-صورة-شريط-التنسيق-هنا)`
...
`![صورة تُظهر القسم النشط ملوَّنًا في الشريط الجانبي أثناء التمرير](ضع-رابط-صورة-scroll-spy-هنا)`
...
`![صورة لنافذة الإعدادات توضح ORG/DOM/ID/Status وحقول SEO](ضع-رابط-صورة-الإعدادات-هنا)`
...
`![صورة للمستند بعد التصدير مفتوح في متصفح آخر](ضع-رابط-صورة-الملف-النهائي-هنا)`
